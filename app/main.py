...
# Import the TaskTitanApp from views/main_window.py
from TaskTitan.app.views.main_window import TaskTitanApp as MainWindow

# Define SimpleMainWindow directly in this file
...
class SplashScreen(QWidget):
    ...
    def __init__(self):
        ...
        # Store a reference to app controller (set later)
        self.app = None
    ...
    def update_progress(self):
        ...
        if self.current_progress >= 100:
            self.timer.stop()
            if self.app:
                QTimer.singleShot(200, self.app.show_main_window)
            else:
                print("Error: App reference not set in splash screen")
...
class TaskTitanApp:
    ...
    def __init__(self):
        ...
        # Store app reference in splash screen
    ...
    def show_main_window(self):
        ...
        # Create and show main window (using the actual TaskTitanApp implementation)
